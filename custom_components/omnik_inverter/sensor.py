...
SENSOR_DESCRIPTIONS: tuple[OmnikSensorEntityDescription, ...] = (
    ...
    OmnikSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:flash-outline",
        value_fn=lambda data: data.dc_input_voltage_2,
    ),
    OmnikSensorEntityDescription(
        key="dc_input_voltage_3",
        ...
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:flash-outline",
        value_fn=lambda data: data.dc_input_voltage_3,
    ),
    OmnikSensorEntityDescription(
    ...
    OmnikSensorEntityDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:flash-outline",
        value_fn=lambda data: data.dc_input_current_2,
    ),
    OmnikSensorEntityDescription(
        key="dc_input_current_3",
        ...
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:flash-outline",
        value_fn=lambda data: data.dc_input_current_3,
    ),
    OmnikSensorEntityDescription(
    ...
    OmnikSensorEntityDescription(
        ...
        name="AC Output Voltage 2",
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        device_class=SensorDeviceClass.VOLTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:flash-outline",
        value_fn=lambda data: data.ac_output_voltage_2,
    ),
    OmnikSensorEntityDescription(
        key="ac_output_voltage_3",
        translation_key="ac_output_voltage_3",
        name="AC Output Voltage 3",
        native_unit_of_measurement=UnitOfElectricPotential.VOLT,
        device_class=SensorDeviceClass.VOLTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:flash-outline",
        value_fn=lambda data: data.ac_output_voltage_3,
    ),
    OmnikSensorEntityDescription(
    ...
    OmnikSensorEntityDescription(
        ...
        name="AC Output Current 2",
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        device_class=SensorDeviceClass.CURRENT,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:flash-outline",
        value_fn=lambda data: data.ac_output_current_2,
    ),
    OmnikSensorEntityDescription(
        key="ac_output_current_3",
        translation_key="ac_output_current_3",
        name="AC Output Current 3",
        native_unit_of_measurement=UnitOfElectricCurrent.AMPERE,
        device_class=SensorDeviceClass.CURRENT,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:flash-outline",
        value_fn=lambda data: data.ac_output_current_3,
    ),
    OmnikSensorEntityDescription(
    ...
    OmnikSensorEntityDescription(
        key="ac_output_frequency_2",
        translation_key="ac_output_frequency_2",
        name="AC Output Frequency 2",
        native_unit_of_measurement=UnitOfFrequency.HERTZ,
        device_class=SensorDeviceClass.FREQUENCY,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:sine-wave",
        value_fn=lambda data: data.ac_output_frequency_2,
    ),
    OmnikSensorEntityDescription(
        key="ac_output_frequency_3",
        translation_key="ac_output_frequency_3",
        name="AC Output Frequency 3",
        native_unit_of_measurement=UnitOfFrequency.HERTZ,
        device_class=SensorDeviceClass.FREQUENCY,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:sine-wave",
        value_fn=lambda data: data.ac_output_frequency_3,
    ),
    OmnikSensorEntityDescription(
        key="ac_output_power",
    ...
    OmnikSensorEntityDescription(
        ...
        name="AC Output Power 2",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:flash-outline",
        value_fn=lambda data: data.ac_output_power_2,
    ),
    OmnikSensorEntityDescription(
        key="ac_output_power_3",
        translation_key="ac_output_power_3",
        name="AC Output Power 3",
        native_unit_of_measurement=UnitOfPower.WATT,
        device_class=SensorDeviceClass.POWER,
        state_class=SensorStateClass.MEASUREMENT,
        icon="mdi:flash-outline",
        value_fn=lambda data: data.ac_output_power_3,
    ),
)
